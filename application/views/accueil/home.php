        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 centPic">
                    <img class="img-responsive"  src="assets/images/bizPic.png"/>
                </div>
            </div>
        </div>   
    </div>
        ...
        <div class="row">
            ...
            <div class="portfolio_block columns3   pretty" data-animated="fadeIn">  
                    <div class="element col-sm-4   gall branding">
                        <a class="plS" href="assets/images/prettyPhotoImages/pic1.jpg" rel="prettyPhoto[gallery2]">
                            <img class="img-responsive picsGall" src="assets/images/prettyPhotoImages/thumb_pic1.jpg" alt="pic1 Gallery"/>
                        </a>
                    ...
                    <div class="element col-sm-4  gall branding">
                        <a class="plS" href="assets/images/prettyPhotoImages/pic2.jpg" rel="prettyPhoto[gallery2]">
                            <img class="img-responsive picsGall" src="assets/images/prettyPhotoImages/thumb_pic2.jpg" alt="pic2 Gallery"/>
                        </a>
                    ...
                    <div class="element col-sm-4  gall web">
                        <a class="plS" href="assets/images/prettyPhotoImages/pic3.jpg" rel="prettyPhoto[gallery2]">
                            <img class="img-responsive picsGall" src="assets/images/prettyPhotoImages/thumb_pic3.jpg" alt="pic3 Gallery"/>
                        </a>
                        <div class="view project_descr ">
                    ...
                    <div class="element col-sm-4  gall  text_styles">
                        <a class="plS" href="assets/images/prettyPhotoImages/pic4.jpg" rel="prettyPhoto[gallery2]">
                            <img class="img-responsive picsGall" src="assets/images/prettyPhotoImages/thumb_pic4.jpg" alt="pic1 Gallery"/>
                        </a>
                        <div class="view project_descr ">
                    ...
                    <div class="element col-sm-4  gall  web">
                        <a class="plS" href="assets/images/prettyPhotoImages/pic5.jpg" rel="prettyPhoto[gallery2]">
                            <img class="img-responsive picsGall" src="assets/images/prettyPhotoImages/thumb_pic5.jpg" alt="pic1 Gallery"/>
                        </a>
                        <div class="view project_descr center">
                    ...
                    <div class="element col-sm-4  gall  polygraphy">
                        <a class="plS" href="assets/images/prettyPhotoImages/pic6.jpg" rel="prettyPhoto[gallery2]">
                            <img class="img-responsive picsGall" src="assets/images/prettyPhotoImages/thumb_pic6.jpg" alt="pic1 Gallery"/>
                        </a>
                        <div class="view project_descr ">
                    ...
                    <div class="element col-sm-4   gall branding">
                        <a class="plS" href="assets/images/prettyPhotoImages/pic7.jpg" rel="prettyPhoto[gallery2]">
                            <img class="img-responsive picsGall" src="assets/images/prettyPhotoImages/thumb_pic7.jpg" alt="pic1 Gallery"/>
                        </a>
                        <div class="view project_descr ">
                    ...
                    <div class="element col-sm-4  gall text_styles">
                        <a class="plS" href="assets/images/prettyPhotoImages/pic8.jpg" rel="prettyPhoto[gallery2]">
                            <img class="img-responsive picsGall" src="assets/images/prettyPhotoImages/thumb_pic8.jpg" alt="pic1 Gallery"/>
                        </a>
                        <div class="view project_descr ">
                    ...
                    <div class="element col-sm-4  gall polygraphy">
                        <a class="plS" href="assets/images/prettyPhotoImages/pic9.jpg" rel="prettyPhoto[gallery2]">
                            <img class="img-responsive picsGall" src="assets/images/prettyPhotoImages/thumb_pic9.jpg" alt="pic1 Gallery"/>
                        </a>
                        <div class="view project_descr ">
    ...
    <div id="news">
        ...
        <div class="container">
                <div class="row news">
                    ...
                    <img class="img-responsive picsGall" src="assets/images/picNews/news1.jpg"/>
                    ...
                    <img class="img-responsive picsGall" src="assets/images/picNews/news2.jpg"/>
            ...
            <div class="container">
                <div class="row news2 news">
                    <div class="col-md-6 text-left">
                    <img class="img-responsive picsGall" src="assets/images/picNews/news3.jpg"/>
                    <h3><a href="#">Lorem Ipsum Dolor sit Amet Pelenntesque Sodales!</a></h3>
                    <ul>
                        <li><i class="fa fa-calendar"></i>April 25, 2014</li>
                        <li><a href="#"><i class="fa fa-folder-open"></i>Staff</a></li>
                    ...
                    <div class="col-md-6 text-right">
                    <img class="img-responsive picsGall" src="assets/images/picNews/news4.jpg"/>
                    <h3><a href="#">Nam in Nisl id Ipsum Feugiat Posuere ut sit Amet Sem</a></h3>
                    <ul>
                        <li><i class="fa fa-calendar"></i>April 25, 2014</li>
                        <li><a href="#"><i class="fa fa-folder-open"></i>Staff</a></li>
            ...
            <div class="container">
                <div class="row news2 news">
                    <div class="col-md-6 text-left">
                    <img class="img-responsive picsGall" src="assets/images/picNews/news5.jpg"/>
                    <h3 ><a href="#">Lorem Ipsum Dolor sit Amet Pelenntesque Sodales!</a></h3>
                    <ul>
                        <li><i class="fa fa-calendar"></i>April 25, 2014</li>
                        <li><a href="#"><i class="fa fa-folder-open"></i>Staff</a></li>
                    ...
                    <div class="col-md-6 text-right">
                    <img class="img-responsive picsGall" src="assets/images/picNews/news6.jpg"/>
                    <h3><a href="#">Nam in Nisl id Ipsum Feugiat Posuere ut sit Amet Sem</a></h3>
                    <ul>
                        <li><i class="fa fa-calendar"></i>April 25, 2014</li>
                        <li><a href="#"><i class="fa fa-folder-open"></i>Staff</a></li>
